...
#   timestamp: 2023-07-14T11:23:06+00:00
...
class HolidayCalendarSpec(BaseModel):
    ...
    calendar_identifiers: List[constr(regex=r"^(FUT|MIC|FX):.+$", strict=True)] = Field(default_factory=list)
...
class RunState(BaseModel):
    ...
    calculation_start_ts: MerqTimestamp
