...
#   timestamp: 2023-08-17T17:01:29+00:00
...
class ClientIndexConfigBase(BaseModel):
    ...
    base_date: constr(regex=r"^[0-9]{4}[-/][0-9]{2}[-/][0-9]{2}", strict=True) = Field(
...
class LevelOverride(BaseModel):
    ...
    date: constr(regex=r"^[0-9]{4}[-][0-9]{2}[-][0-9]{2}", strict=True)
    level: Any
    comment: Optional[StrictStr] = None


class ClientMultiEBConsituent(BaseModel):
    date: constr(regex=r"^[0-9]{4}-[0-9]{2}-[0-9]{2}", strict=True) = Field(..., example="2022-03-11")
...
class IndexDefinitionPost(BaseModel):
    ...
    first_value_date: Optional[constr(regex=r"^[0-9]{4}[-/][0-9]{2}[-/][0-9]{2}", strict=True)] = Field(
